...
public class FantasticTrippleRemedyLogger {

	
	static Logger REMEDYLOGGER = Logger.getLogger(FantasticTrippleRemedyLogger.class.getName());
	FileHandler remedyLoggerTextFileAttributes;
	
	
	
public FantasticTrippleRemedyLogger() {
