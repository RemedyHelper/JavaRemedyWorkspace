...
public class RemedyTestCasesActualSEP15Backup extends RemedySignUpCommonMethodsAndVarriables
{
...
//		    		remedyHashTableTestCasesActual.put("hashKeyTestCaseActual", homeidftitlePageFactory.getText());
		    	...
		    	case 3:
		    		remedyHashTableTestCasesActual.put("hashKeyTestCaseActual", String.valueOf(RemedyMain.homeidquotesPageFactory.isDisplayed()));
		    		remedyHighlightAndScreenshotTestedElement(remedyTestCaseIterator, RemedyMain.homeidquotesPageFactory, driver);
		    		
		    		System.out.println(driver.findElement(By.id("id_quotes")).getText());
		    		
		    		System.out.println(String.valueOf(RemedyMain.homeidquotesPageFactory.getText()));
		    		System.out.println(String.valueOf(RemedyMain.homeidquotesPageFactory.getText()));
		    		System.out.println(String.valueOf(RemedyMain.homeidquotesPageFactory.getText()));
...
//		    				&& (RemedyRegexInterface.remedyRegexDateValidator(hometimestampPageFactory.getText())));
		    	...
		    	case 16:
		    		remedyHashTableTestCasesActual.put("hashKeyTestCaseExpected", RemedyMain.homeidquotesPageFactory.getText());
